...
export default function ExcelUpload({ onDataParsed }: ExcelUploadProps) {
  ...
  return (
    <Card>
      ...
      <CardContent>        <div className="space-y-4">          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <h4 className="font-semibold text-blue-800 mb-2 flex items-center gap-2">
              <FileSpreadsheet className="h-4 w-4" />
              Como usar o upload de Excel:
            </h4>
            <ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
              <li>Clique em "Escolher arquivo" abaixo</li>
              <li>Selecione seu arquivo .xlsx</li>
              <li>O sistema processará automaticamente os dados</li>
              <li>Se não tiver um arquivo, baixe o exemplo primeiro!</li>
            </ol>
          </div>
          ...
          {error && (
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                <label className="block text-sm font-medium text-[#110043] mb-2">
              ...
              <Button 
                ...
                className="border-[#3700ff] text-[#3700ff] hover:bg-[#3700ff] hover:text-white transition-colors self-end"
              >
            ...
            {isLoading && (
              <div className="flex items-center gap-2 text-[#3700ff] text-sm">
                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#3700ff]"></div>
                Processando arquivo...
              </div>
            )}
          </div>
